const CACHE_NAME = "vibecoding-deck-v4.4.2";
const APP_SHELL = [
  "./",
  "index.html",
  "wissen.html",
  ...
  "images/pointing-hand-audience.png",
  ...
  "images/vibecoding-info-qr.svg?v=4.4.2",
  ...
  "images/videos/vibecoding-heise-2026.jpg",
  "icons/icon-192.svg",
  "icons/icon-180.png",
  "icons/icon-192.png",
  "icons/icon-512.svg",
